...
- US: Fed / rates path after Jul payrolls **−23k** + **−103k** revisions (Sep hike odds eased); Freddie **6.69%** sticky vs softer 10y (LEN); ISM Jul **55.6** (ODFL); cocoa ~**$5.9k** (HSY KPI cooler); healthcare policy (UNH); SPCX unlock **Aug 20** next (high-beta)
- Asia/HK overnight: China export beat → HSI **25,668 (+0.5%)** Aug 7; Nikkei AI/semis soft is spillover tone only
